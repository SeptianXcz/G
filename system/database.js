module.exports = (m) => {
   ...
   if (setting) {
      ...
      if (!('sk_author' in setting)) setting.sk_author = '@9knatzz-WB'
      ...
      if (!('link' in setting)) setting.link = 'https://chat.whatsapp.com/HjPoA3EZ2mc22ngHjZJLbE'
   } else {
      global.db.setting = {
         autodownload: true,
         chatbot: true,
         ...
         link: 'https://chat.whatsapp.com/HjPoA3EZ2mc22ngHjZJLbE'
      }
   }
}